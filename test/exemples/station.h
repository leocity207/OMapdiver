...
struct Station_Exemple
{
	...
	static inline const std::string serialized = R"({"id":"FR_03190_0","label":"Rennes","url":null,"lines":["l1","l2"],"directions":{"LGV_FR8_A_27":"s1","LER_NOR2_A_05":"s1","LGV_FR4_A_00":"s2"},"have_disabled_equipment":null,"have_bike_parking":null,"have_car_parking":null,"have_car_sharing":null,"opening_time":null,"closing_time":null})";
