...
describe('pattern switch component', () => {
	...
	it('special choice', async () => {
		...
		expect(On_Change).not.toHaveBeenCalled();
		const toggle_button = eps_mock.container.querySelector('.switch-special-toggle') as HTMLElement;
		await fireEvent.click(toggle_button!);

		const special_option = eps_mock.container.querySelector('.switch-special-item') as HTMLElement;
	...
	it('special choice as default', async () => {
		...
		const special_toggle = eps_mock.container.querySelector('.switch-special-toggle') as HTMLElement;
		...
		const normal_button = eps_mock.container.querySelector('.switch-normal-option.is-selected') as HTMLElement;
