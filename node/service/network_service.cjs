...
class Network_Service extends Service
{
	...
	{
		super();
		this.calendar_patterns = new Cache_Memory_Agregate_JSON("calendar_patterns");
		this.landmarks         = new Cache_Memory_Agregate_JSON("landmarks");
		this.lines             = new Cache_Memory_Agregate_JSON("lines");
		this.operators         = new Cache_Memory_Agregate_JSON("operators");
		this.organisers        = new Cache_Memory_Agregate_JSON("organisers");
		this.stations          = new Cache_Memory_Agregate_JSON("stations");
		this.stop_patterns     = new Cache_Memory_Agregate_JSON("stop_patterns");
		this.territories       = new Cache_Memory_Agregate_JSON("territories");

		this.netwoks           = new Cache_Memory_Agregate_JSON("networks");
	...
	async Update_Data()
	{
		...
		this.loading.promise = (async () => {
			try{
				...
				{
					if(Config.VERBOSE) console.log("[INFO] Updating calendar_patterns");
				...
				{
					if(Config.VERBOSE) console.log("[INFO] Updating organisers");
				...
				{
					if(Config.VERBOSE) console.log("[INFO] Updating territories");
				...
				{
					if(Config.VERBOSE) console.log("[INFO] Updating netwoks");
