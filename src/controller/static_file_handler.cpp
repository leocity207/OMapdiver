...
Static_File_Manager::Static_File_Manager(std::shared_ptr<oatpp::web::mime::ContentMappers>& apiContentMappers)
	: oatpp::web::server::api::ApiController(apiContentMappers)
{
}

oatpp::String Static_File_Manager::Get_File(oatpp::String& fileName)
{
...
const char * Static_File_Manager::Get_Content_Type(const std::string& path) {
