#ifndef TIMETABLE_DATA_HANDLER_HPP
#define TIMETABLE_DATA_HANDLER_HPP
...
class Timetable_Data_Handle : public oatpp::web::server::api::ApiController
{
public:
	Timetable_Data_Handle(OATPP_COMPONENT(std::shared_ptr<oatpp::web::mime::ContentMappers>, apiContentMappers));
	...
	ENDPOINT("GET", "dyn/timetable_data", Get_Timetable_Data)
	{
...
#endif //TIMETABLE_DATA_HANDLER_HPP
